...
export function Testimonial() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg  bg-background md:shadow-xl bg-black text-white ">
        <div>
            <h1 className='text-center font-bold text-5xl sm:text-6xl tracking-tighter mt-16'>"Voices of Satisfaction"</h1>
            <p className="max-w-4xl mx-auto text-center text-xl pt-12 mb-12">"Don’t just take our word for it—hear what our clients have to say! At Fortune Sports, we take pride in delivering exceptional service and top-notch facilities.Explore their testimonials to see how we’ve helped elevate their game and streamline their sports bookings."</p>
        </div>
